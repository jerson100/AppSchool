...
<link rel="stylesheet" href="assets/css/pages/horario3.css">
...
<body class="no-skin">
				...
				<div class="je-container">
					<div class="je-item" style="position: relative;">
						...
						<div
							...
							<label>Mostrar todo</label> <input type="checkbox"
								id="mostrarTodo">
						</div>
					</div>
					<div class="je-item">
										...
										<c:forEach items="${day.value}" var="data">
											...
											<div class="class-container">
												...
												<div class="name-teacher">
													<p class="bold">
														<c:out
															value="${sessionScope.usuarioSesion.idPerfil == 2 ? 'Sección:':'Docente:'}"></c:out>
													</p>
													<p>${data.mensaje}</p>
												</div>
											</div>
	...
	<script src="assets/js/pages/horario3.js"></script>
</body>
</html>