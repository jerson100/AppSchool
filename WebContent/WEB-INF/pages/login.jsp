...
<meta name="description"
	content="Login para acceder a la plataforma de la escuela Uribe's School">
...
<link rel="stylesheet" href="assets/css/components/login-slider3.css">
<link rel="stylesheet" href="assets/css/utils/animation3.css">
<link rel="stylesheet" href="assets/css/pages/login3.css">
...
<body class="je-scroll">
					...
					<div class="login__body-inner">
						...
						<form class="login__form form" id="form-login">
							...
							<div class="form__group form__group--mb-4">
								<div class="input-icon">
									<i class="input-icon__icon ace-icon fas fa-lock"></i> <input
										type="password" name="password" class="input-icon__input"
							...
							<button
								class="login__button je-btn je-btn--fill je-btn--upper je-btn--shadow"
	...
	<script src="assets/js/utils/login-slider3.js"></script>
	<script src="assets/js/pages/login3.js"></script>
</body>
</html>