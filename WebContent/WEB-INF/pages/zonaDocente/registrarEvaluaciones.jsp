...
<body class="no-skin je-scroll">
		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<jsp:include page="../../includes/breadcrumb.jsp">
					...
					<jsp:param value="zonaDocente/registrarNotas" name="href" />
				</jsp:include>
			</div>
			<div class="registro-evaluaciones">
				<h1 class="registro-evaluaciones__title">Registro de notas</h1>
				<form class="registro-evaluaciones__form"
					id="registro-evaluaciones__form">
					<div class="registro-evaluaciones__group">
						<label>Grado</label> <select name="grades" id="grades">
							<option value="none">Seleccione un grado...</option>
							<c:forEach items="${requestScope.secciones}" var="seccion">
								<option value="${seccion.idSecGraNiv}">${seccion.grado}
									${seccion.nivel}</option>
							</c:forEach>
						</select>
					</div>
					<div class="registro-evaluaciones__group">
						<label>Curso</label> <select name="courses" id="courses">
	...
	<script src="assets/js/pages/registrarNotas/index3.js"></script>
</body>
</html>